...
<body>
	...
	<div class="content">
		...
		<div class="stack">
			...
			<div class="subtitle"><p>Stacks&Tools that I can make use of.</p></div>
		...
		<div class="clickbox">
			<a href="https://davidyoon1001.github.io/bookmark-landing-page/" target="_blank">
				<div id="w75">
					<div class="description">
						<div><p class="comment1">Bookmark landing page - Overview</p></div>
						<div><p class="comment2">Bookmark lending page - built with HTML, CSS, and Vanilla JS.</p></div>
						<div class="logourl">
							<img class="logoimg" src="<spring:url value='/resources/logo-webpage.png'/>">
							<p class="comment3"> https://github.com/davidyoon1001/bookmark-landing-page</p>
						</div>
					</div>
				</div>
				<div id="w25">
					<div class="descimg">
						<img class="projectimg" src="<spring:url value='/resources/bookmark-page.png'/>">
					</div>
				</div>
			</a>
		</div>
		<div class="clickbox">
			<a href="https://davidyoon1001.github.io/tip-calculator-app/" target="_blank">
				<div id="w75">
					<div class="description">
						<div><p class="comment1">Tip Calculator App - Overview</p></div>
						<div><p class="comment2">Simple tip calculating application - built with HTML, CSS and Vanilla JS</p></div>
						<div class="logourl">
							<img class="logoimg" src="<spring:url value='/resources/logo-webpage.png'/>">
							<p class="comment3"> https://davidyoon1001.github.io/tip-calculator-app/</p>
						</div>
					</div>
				</div>
				<div id="w25">
